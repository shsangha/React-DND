beforeEach(() => {
  ...
  cy.visit("/behavior/swap");
});

describe("tests logic for swap behavior on containers", () => {
  describe('"horizontal list swap without being cancelled"', () => {
    it("mouse", () => {
        ...
        .then(el => {
          ...
          cy.wrap(el)
            ...
            .and($res => {
              ...
              expect($res[1].textContent).to.equal("2");
              expect($res[2].textContent).to.equal("1");
              expect($res[3].textContent).to.equal("4");
              expect($res[4].textContent).to.equal("5");
            })
            .window()
